(function(exports) {
	...
	var DEFAULT_DURATION = exports.DEFAULT_DURATION = 128;
	var DEFAULT_CHANNEL  = exports.DEFAULT_CHANNEL  = 0;
...
*/
	...
	Track.prototype.addNote = function(channel, pitch, dur, time) {
		this.addNoteOn(channel, pitch, time, DEFAULT_VOLUME);
		if (dur) {
			this.addNoteOff(channel, pitch, dur, DEFAULT_VOLUME);
		}
	};
